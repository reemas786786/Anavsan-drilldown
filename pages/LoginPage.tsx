                ...
                <div className="mx-auto w-full max-w-sm">
                    ...
                    <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                        ...
                        <div className="bg-primary/5 p-3 rounded-lg border border-primary/10">
                            <p className="text-xs text-text-secondary mb-2 font-semibold uppercase tracking-wider">Demo Quick Login:</p>
                            <div className="flex gap-2">
                                <button type="button" onClick={() => setEmail('finops@mail.com')} className="text-xs bg-white px-2 py-1 rounded border border-border-color hover:border-primary hover:text-primary transition-colors">FinOps</button>
                                <button type="button" onClick={() => setEmail('dataengineer@mail.com')} className="text-xs bg-white px-2 py-1 rounded border border-border-color hover:border-primary hover:text-primary transition-colors">Data Engineer</button>
                            </div>
                        </div>
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-4">
                        <button 
                            onClick={onSSOLogin}
                            className="flex items-center justify-center px-4 py-3 bg-gray-50 rounded-lg text-text-secondary hover:bg-gray-100 transition-colors border border-gray-200"
                        >
                           <IconGoogle />
