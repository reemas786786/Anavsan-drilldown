...
const DashboardCard: React.FC<DashboardCardProps> = ({ dashboard, onViewClick, onEditClick, onShareClick, onDeleteClick }) => {
    ...
    return (
        <button
            onClick={onViewClick}
            className="bg-surface p-6 rounded-[24px] border border-border-light shadow-sm flex flex-col h-full text-left hover:ring-2 hover:ring-primary focus:outline-none focus:ring-2 focus:ring-primary transition-all group"
        >
...
const Dashboards: React.FC<DashboardsProps> = ({ dashboards, onDeleteDashboardClick, onAddDashboardClick, onEditDashboardClick, onViewDashboardClick }) => {
  return (
    <div className="px-6 pt-4 pb-12 space-y-5 h-full flex flex-col overflow-y-auto no-scrollbar">
