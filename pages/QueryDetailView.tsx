                ...
                <div className="lg:col-span-3 space-y-4">
                    <div className="bg-white p-6 rounded-3xl border border-border-light shadow-sm">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-8">
                            ...
                            <DetailItem label="Severity" value={<span className={`text-[11px] font-black uppercase ${query.severity === 'High' ? 'text-status-error' : 'text-status-warning'}`}>{query.severity}</span>} />
                        </div>
                    </div>
